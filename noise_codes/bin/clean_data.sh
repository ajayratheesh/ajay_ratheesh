...
noiseconfigfile=$6
caldblld=$7
bunchcleanfile=`echo $eventfile|sed 's/.evt/_bc.evt/'`
bunchlivetime=`echo $eventfile|sed 's/.evt/_bc_livetime.fits/'`
...
do
	...
	echo "cztnoisypixclean $f $caldbbadpix $noiseconfigfile"
	...
	do
		...
		bindataout=$bindataout"E"$i"_compton"
